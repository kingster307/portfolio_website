					...
					<div>
						<div class="ml-0 ml-sm-1 mt-5 pt-5 panel">
							...
							<div class="collapse" id="collOne">
								...
								<p class="dropdownText">With a minor in graphic design, I the 
									background & creativity to craft magnificent UI/UX interfaces as 
									well as hands on experience with a plethora of graphics software 
					...
					<div>
						<div class="ml-0 ml-sm-5 pl-sm-5 pt-5 mt-5 panel">
							...
							<div class="collapse" id="collThree">
								...
								<p class="dropdownText">No matter what I’m doing you can bet your 
									last dollar that I am mentally thinking of 100 different 
									ways to improve any given task, in various ways. Literally like a 
									psychopath for innovating.</p>
